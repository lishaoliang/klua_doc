...
```c
// C实现文件: ./klb/src_packages/klbwui/embed_widgets/klbui_richtext.c
// 窗口实现: ./klb/src_packages/klbwui/embed_wnd/klbwnd_richtext.c
...
* 先公共后私有; ① 见 `klbui_css_std_function.c`; ②③ 见 `klbui_richtext.c` `init_func_map`
...
| 自定义   | `title`                           | get/set | 富文本标题                       |
| 自定义   | `value`                           | get/set | 富文本内容; 与 title 独立           |
