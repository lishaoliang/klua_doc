...
> `klua_doc/klb/klbui/design/c-gui-api.md` — 头文件: `klb/inc/klbgui/`

面向 **C/C++ 产品** 与高级绑定开发. Lua 脚本 API 见 `require("kgui")` 与 **klbcore.klbui**. 分层 [layers.md](layers.md).
...
| API | 说明 |
|-----|------|
| `klb_gui_register_extension` | 见 [extension.md](extension.md) |
