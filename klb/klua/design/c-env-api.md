...
> `klua_doc/klb/klua/design/c-env-api.md` — 头文件: `klb/inc/klua/`

面向 **C/C++ 产品代码** (klbapp, 独立 `klua`, 高级绑定). Lua **L3 k\*** 见 [k/readme.md](../k/readme.md)、[k-bindings.md](k-bindings.md); 清单 [require-guide.md](require-guide.md). 分层 [layers.md](layers.md).
...
Lua 侧见 [k/klpc.lua.md](../k/klpc.lua.md); 路径详 [env-extension.md](env-extension.md).
...
标准 `klua_ex_*` 表见 [env-extension.md](env-extension.md).
...
业务脚本用 `require("kco")`; 见 [coroutine.md](coroutine.md).
...
配合 `require("kthread")`; 见 [k/kthread.lua.md](../k/kthread.lua.md).
