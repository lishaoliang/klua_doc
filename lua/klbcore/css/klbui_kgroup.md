...
```c
// C实现文件: ./klb/src_packages/klbwui/embed_widgets/klbui_group.c
// 窗口实现: ./klb/src_packages/klbwui/embed_wnd/klbwnd_group.c
...
* 先公共后私有; ① 见 `klbui_css_std_function.c`; ②③ 见 `klbui_group.c` `init_func_map`
