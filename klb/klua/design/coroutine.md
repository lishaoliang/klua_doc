...
> `klua_doc/klb/klua/design/coroutine.md` — 代码: `klb/src_c/klua/klua_base/klua_kcoro.c`, `klb/src_c/klua/extension/klua_ex_coroutine.c`
...
非 Lua `require`; 由 `klua_register_extension_std` 在 create 时注册. 全表见 [env-extension.md](env-extension.md).
