...
| ... | ... | ... | ... |
| BitmapEntry[ClusterCount+1] | ClusterCount - 1 | 1 | This field is mandatory and Section 7.1.5.1 defines its contents. Note: the Main and Backup Boot Sectors both contain the ClusterCount field. |
| Reserved | ClusterCount | (DataLength \* 8) – ClusterCount | This field is mandatory and its contents, if any, are reserved. Note: the Main and Backup Boot Sectors both contain the ClusterCount field. |
