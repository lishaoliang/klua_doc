...
> 代码: `klb/src_c/klua/klua_multithread/klua_kthread.c`
...
- 每个 worker 为独立 `klua_env_t`, 自有 `loop_once`; 预加载链与主线程相同 (见 [preload 设计](../design/preload.md))
- 第 4 个参数起可通过 [ksys](ksys.lua.md) / [kenv](kenv.lua.md) `get_args` 读取
- 跨线程通信用 [klpc](klpc.lua.md); 业务划分见 **klbcore-design** § kthread
