...
> `klua_doc/klb/klbui/design/layers.md` — 代码: `klb/inc/klbgui/`, `klb/src_c/klbgui/`
...
| 类别 | 头文件 | 文档 |
|------|--------|------|
| GUI 主 API | `klb_gui.h` | [c-gui-api.md](c-gui-api.md) |
| 窗口基类 | `klb_wnd.h` | 同上 |
| GUI 扩展 | `klbui_extension.h` | [extension.md](extension.md) |
| CSS / 事件 | `klbui_css.h`, `klbui_event.h` | [css/css.md](../css/css.md) |

### B. Lua 脚本

| 加载 | 示例 | 文档 |
|------|------|------|
| `kgui` | `require("kgui")` | [klua/k/kgui.lua.md](../../klua/k/kgui.lua.md) |
...
| 新 Lua 控件 API | L3 | `klua_open_kgui` 增补 + `kgui` | kgui.lua.md |
| 纯 Lua UI 描述 | L4 | klbcore.klbui | klbcore-design |
| 新具体控件 type | wndhash | `wndhash_register` 或扩展包 | widgets/*.md |
| C 产品持 GUI | L1/L2′ | `klb_gui_*` / klbapp | c-gui-api.md |
...
| [c-gui-api.md](c-gui-api.md) | `klb_gui.h` 导读 |
| [wnd.md](wnd.md) | 窗口树 |
