...
> 代码: `klb/src_c/klua/klua_util/klua_kenv.c`
...
- `exit` / `is_exit` 与 [ksys](ksys.lua.md) 等价, 任选其一
- `tick_count` 为 **env 级** 滴答; 系统级见 [ktime](ktime.lua.md) / [kgui](kgui.lua.md) `tick_count`
- C 生命周期见 [lifecycle 设计](../design/lifecycle.md)
