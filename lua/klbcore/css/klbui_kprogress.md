...
```c
// C实现文件: ./klb/src_packages/klbwui/embed_widgets/klbui_progress.c
// 窗口实现: ./klb/src_packages/klbwui/embed_wnd/klbwnd_progress.c
...
* 先公共后私有; ① 见 `klbui_css_std_function.c`; ②③ 见 `klbui_progress.c` `init_func_map`
...
| 控件通用  | `style-focus-without-redraw`      | get/set | 聚焦不重绘; kprogress 默认 `true` |
